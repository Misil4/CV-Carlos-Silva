                ...
                <Box sx={{ display : "flex",justifyContent : "center",alignContent : "center" }}>
                    <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                        <Grid item xs={2} sm={3} md={3} >
                            ...
                            <p className={styles.project_title}>responsive ecommerce for korean cosmetics made with PHP, CSS, JS and SQL </p>
                        </Grid>
                        <Grid item xs={2} sm={3} md={3}>
                            <Typography variant="h5" component="div" className={styles.project_title}>Ballin</Typography>
                            <div className={styles.image}>
                            ...
                            <p className={styles.project_title}>Android app for natural park management made with React Native, MongoDB, NodeJS and Socket.io</p>
                        </Grid>
                        <Grid item xs={2} sm={3} md={3}>
                            <Typography variant="h5" component="div" className={styles.project_title}>Fake-Facebook</Typography>
                            <div className={styles.image}>
                            ...
                            <p className={styles.project_title}>Facebook Android App clone made with Expo and React Styled Components</p>
                        </Grid>
                        <Grid item xs={2} sm={3} md={3}>
                            <Typography variant="h5" component="div" className={styles.project_title}>SnakeJS</Typography>
                            <div className={styles.image}>
                            ...
                            <p className={styles.project_title}>Snake game made in React.JS with canvas</p>
                        </Grid>
                    </Grid>
                </Box>
            </div>
